...
List<WebElement> success_msg;
	...
	public void change_password() throws Exception {
		...
		for (int i = 0; i < 2; i++) {
			...
			Assert.assertEquals(actresult, true, "Seems like password not updated successfully because no success message found!");
	...
	public void login_with_new_pass() throws Exception {
