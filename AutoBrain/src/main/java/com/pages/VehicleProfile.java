...
public class VehicleProfile extends Login {
	...
	public void VehicleProfileInfo() throws Exception {
		...
		// Enter VIN number
		wait(driver, 15).until(ExpectedConditions.visibilityOfElementLocated(
		...
		String page_loaded = wait(driver, 40).until(
		...
		String page_loaded_after_refresh = wait(driver, 40).until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//h4[contains(text(),'Vehicle Profile')]")))
				.getText();
	...
	public void Ins_Reg_Forms() throws Exception {
		...
		Thread.sleep(1000);
		Insurance_Eff_Date = wait(driver, 5).until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//li[contains(text(),'Effective Date')]/following-sibling::li")))
				.getText();

		Insurance_Exp_Date = wait(driver, 5)
				.until(ExpectedConditions
...
//NEW FORM CAR REGISTRATION (Click on Edit button) 
	...
	public void validate_data() throws Exception {
		...
		String act_colour = ((JavascriptExecutor) driver)
		...
		String act9 = wait(driver, 5).until(ExpectedConditions
		...
		String act10 = wait(driver, 5).until(ExpectedConditions.visibilityOfElementLocated(
